...
I am a [DevOps](https://en.wikipedia.org/wiki/DevOps), [SRE](https://en.wikipedia.org/wiki/Site_reliability_engineering) and [Solutions Architect](https://en.wikipedia.org/wiki/Solution_architecture) with 18 years of hands-on experience  with Fortune 500 Companies, Banks, ISPs, Data Centers, Media Conglomerates, FMCGs and Startups
